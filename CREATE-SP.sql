...
INSERT IGNORE INTO SETTINGS (name) VALUE ('WUNDERGROUND_ID');
INSERT IGNORE INTO SETTINGS (name) VALUE ('WUNDERGROUND_PASSWORD');
INSERT IGNORE INTO SETTINGS (name) VALUE ('showMetricAndCelsiusMeasurements');
INSERT IGNORE INTO SETTINGS (name) VALUE ('showPressureInMillibars');
...
BEGIN
    ...
    SELECT VALUE FROM SETTINGS WHERE NAME = 'WUNDERGROUND_ID' LIMIT 1 INTO @WUNDERGROUND_ID;
    SELECT VALUE FROM SETTINGS WHERE NAME = 'WUNDERGROUND_PASSWORD' LIMIT 1 INTO @WUNDERGROUND_PASSWORD;
